  ...
  <section class="h-[600px] w-full bg-cover">
    <div class="container flex flex-col justify-center h-full mx-auto text-white">
      ...
      <div class="relative mt-16">
        <label class="inner_search_wrapper w-full">
          <input
            v-model="searchTerm"
            class="bg-white text-black w-full py-4 h-12 px-8 rounded-4xl
                   placeholder:text-[#8997AB] placeholder:text-xl text-xl"
            type="text"
        ...
        <input
          type="submit"
          value="Search"
          class="absolute right-0 h-full px-8 rounded-full
